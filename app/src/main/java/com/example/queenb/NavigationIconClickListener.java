...
public class NavigationIconClickListener implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        final int fragment_base_offset = getAppbarHeight();
        ObjectAnimator animator = ObjectAnimator.ofFloat(sheet, "translationY", backdropShown ? translateY : fragment_base_offset);

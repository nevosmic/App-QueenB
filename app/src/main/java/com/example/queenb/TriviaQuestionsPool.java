...
public class TriviaQuestionsPool extends SQLiteOpenHelper
{
    ...
    TriviaQuestionsPool(Context context)
    {
    ...
    void allQuestion() {
        ...
        arraylist.add(new TriviaQuestion("מי מהנשים הבאות יכולה להתגאות בהיותה בין השאר מתכנתת?", "Telescope", "Airoplane", "Electricity", "Train", "Telescope"));
